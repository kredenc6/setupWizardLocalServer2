...
app.get("/gitRepo/status", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, gitFunctions_1.gitFetch()];
            case 1:
                wasFetchSuccessful = _b.sent();
                if (!wasFetchSuccessful) return [3 /*break*/, 3];
                return [4 /*yield*/, gitFunctions_1.gitStatus()];
            case 2:
                _a = _b.sent();
                return [3 /*break*/, 4];
            case 3:
...
app.post("/gitRepo/push", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var status;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, gitFunctions_1.gitPush()];
            case 1:
                status = _a.sent();
...
app.get("/jsonFileNames", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _b;
...
app.get("/jsonFiles", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var fileNames, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
